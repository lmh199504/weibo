<template>
	<div class="login_box">
		<a-tabs v-model:activeKey="activeKey">
			<a-tab-pane key="1" :tab="$t('login.accountLogin')">
				<a-form layout="vertical" :model="formState" @finish="handleFinish" @finishFailed="handleFinishFailed">
					...
					<a-form-item class="login_btn_form_item">
						<a-button class="login_btn" type="primary" html-type="submit"
							:disabled="formState.user === '' || formState.password === ''" @click="login">
							{{ $t("login.login") }}
						</a-button>
					</a-form-item>
					<div class="noaccount">
			...
			<a-tab-pane key="2" :tab="$t('login.safeLogin')" force-render>
